 ...
 */
const validStatuses = ['active', 'suspended', 'deleted', 'pending_verification'];
/**
...
function normalizeStatus(status) {
    ...
    return validStatuses.includes(lower)
        ? lower
...
export function useAuth() {
    ...
    async function login(credentials) {
        ...
        const normalizedUser = {
            ...loggedInUser,
            _id: loggedInUser._id || loggedInUser.id, // Handle both id formats safely
    ...
    async function register(userData) {
        ...
        const normalizedUser = {
            ...newUser,
            _id: newUser._id || newUser.id, // Handle both id formats safely
