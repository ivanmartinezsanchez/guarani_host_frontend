...
import { Users as UsersIcon, Home as HomeIcon, MapPin as MapPinIcon, Calendar as CalendarIcon, ShieldCheck as ShieldCheckIcon, Settings as SettingsIcon, BarChart3 as BarChart3Icon, Database as DatabaseIcon, Monitor as MonitorIcon, ChevronRight as ChevronRightIcon } from 'lucide-vue-next';
// Import DashboardCard component
import DashboardCard from '@/components/ui/DashboardCard.vue';
// Router instance for navigation
const router = useRouter();
/**
 * Navigation functions for each management section
 * These functions handle routing to respective admin pages
 */
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
    ...{ onClick: (__VLS_ctx.navigateToUsers) },
    ...{ onKeydown: (__VLS_ctx.navigateToUsers) },
    ...{ onKeydown: (__VLS_ctx.navigateToUsers) },
    ...{ class: "text-left w-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-xl" },
    'aria-label': "Acceder a gestión de usuarios",
});
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
    ...
    'aria-label': "Acceder a gestión de propiedades",
});
/** @type {[typeof DashboardCard, typeof DashboardCard, ]} */ ;
// @ts-ignore
const __VLS_11 = __VLS_asFunctionalComponent(DashboardCard, new DashboardCard({
    title: "Propiedades",
    subtitle: "Supervisa alojamientos, precios y disponibilidad",
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
    ...
    ...{ onKeydown: (__VLS_ctx.navigateToBookings) },
    ...{ class: "text-left w-full focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-opacity-50 rounded-xl" },
    'aria-label': "Acceder a gestión de reservas",
});
/** @type {[typeof DashboardCard, typeof DashboardCard, ]} */ ;
// @ts-ignore
const __VLS_25 = __VLS_asFunctionalComponent(DashboardCard, new DashboardCard({
    title: "Reservas",
    subtitle: "Monitorea y administra todas las reservas del sistema",
...
});
{
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "flex items-center justify-between text-orange-700 dark:text-orange-300" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
        ...{ class: "text-sm font-medium" },
    });
    const __VLS_28 = {}.ChevronRightIcon;
    /** @type {[typeof __VLS_components.ChevronRightIcon, ]} */ ;
    // @ts-ignore
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
    ...{ onClick: (__VLS_ctx.navigateToSettings) },
    ...
    'aria-label': "Acceder a configuración del sistema",
});
const __VLS_32 = {}.SettingsIcon;
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
    ...{ onClick: (__VLS_ctx.navigateToReports) },
    ...{ class: "bg-white/20 hover:bg-white/30 focus:bg-white/30 backdrop-blur-sm rounded-lg lg:rounded-xl p-3 sm:p-4 transition-all duration-200 text-center group focus:outline-none focus:ring-2 focus:ring-white/50" },
    'aria-label': "Ver reportes y estadísticas",
});
const __VLS_36 = {}.BarChart3Icon;
/** @type {[typeof __VLS_components.BarChart3Icon, ]} */ ;
// @ts-ignore
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
    ...{ onClick: (__VLS_ctx.navigateToDatabase) },
    ...{ class: "bg-white/20 hover:bg-white/30 focus:bg-white/30 backdrop-blur-sm rounded-lg lg:rounded-xl p-3 sm:p-4 transition-all duration-200 text-center group focus:outline-none focus:ring-2 focus:ring-white/50" },
    'aria-label': "Gestionar base de datos",
});
const __VLS_40 = {}.DatabaseIcon;
/** @type {[typeof __VLS_components.DatabaseIcon, ]} */ ;
// @ts-ignore
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
    ...{ onClick: (__VLS_ctx.navigateToSystem) },
    ...{ class: "bg-white/20 hover:bg-white/30 focus:bg-white/30 backdrop-blur-sm rounded-lg lg:rounded-xl p-3 sm:p-4 transition-all duration-200 text-center group focus:outline-none focus:ring-2 focus:ring-white/50" },
    'aria-label': "Monitorear estado del sistema",
});
const __VLS_44 = {}.MonitorIcon;
...
/** @type {__VLS_StyleScopedClasses['dark:text-orange-300']} */ ;
/** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
/** @type {__VLS_StyleScopedClasses['font-medium']} */ ;
/** @type {__VLS_StyleScopedClasses['w-4']} */ ;
/** @type {__VLS_StyleScopedClasses['h-4']} */ ;
