 ...
 */
export const getHostTours = async () => {
    try {
 ...
 */
export const createHostTour = async (formData) => {
    try {
 ...
 */
export const updateHostTour = async (id, formData) => {
    try {
 ...
 */
export const deleteHostTour = async (id) => {
    try {
...
//# sourceMappingURL=hostTourService.js.map