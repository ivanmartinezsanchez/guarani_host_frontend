 ...
 */
const bookingToFormData = (booking, images = []) => {
 ...
 */
export const createUserBooking = async (bookingData, paymentImages = []) => {
    try {
 ...
 */
export const updateUserBooking = async (id, bookingData, paymentImages = [], removedImages = []) => {
    try {
