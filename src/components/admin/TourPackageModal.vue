  ...
  <div class="max-w-7xl mx-auto p-6">
    ...
    <div class="flex flex-wrap justify-between items-center gap-4 mb-6">
      <div class="flex items-center gap-2">
        ...
        <h2 class="text-xl font-semibold">Lista de paquetes</h2>
      </div>
      <div class="flex gap-2 items-center">
        ...
        >
          <PlusIcon class="w-5 h-5" /> Nuevo paquete
        </button>
      </div>
    </div>
      ...
      <table class="min-w-full table-auto text-sm">
        ...
        <tbody>
          ...
          >
            ...
            <td class="px-4 py-2">{{ tour.status }}</td> <!-- Usamos 'status' en lugar de 'available' -->
...
const selectedTour = ref<Partial<Tour>>({
  ...
  description: '',
  price: 0,
  status: 'available', // Usando 'status' en lugar de 'available'
  imageUrls: [],
  host: ''
})
