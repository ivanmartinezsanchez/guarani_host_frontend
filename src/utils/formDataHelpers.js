 ...
 */
export const propertyToFormData = (property, images = []) => {
 ...
 * @returns FormData for multipart/form-data submission.
 */
export const bookingToFormData = (booking, images = []) => {
    const formData = new FormData();
 ...
 */
export const tourToFormData = (tour, images = []) => {
    const formData = new FormData();
...
//# sourceMappingURL=formDataHelpers.js.map